...
https://github.com/Bytom/dashboard/blob/4067d6d9c505147003a68a80b35734ab0cbbb930/src/routes.js#L15-L35
...
https://github.com/Bytom/dashboard/blob/c68fdecc8df116db68f48cda965234003400d269/src/features/transactions/routes.js#L1-L21
...
https://github.com/Bytom/dashboard/blob/c68fdecc8df116db68f48cda965234003400d269/src/features/shared/routes.js#L1-L44
...
再回到第1处代码，可以看到`Show`组件是从外部传进来的，从前面的函数可以看到它对应的是`src/features/transactions/components/Show.jsx`。

我们进去看一下这个`Show.jsx`，首先是定义html组件的函数`render`：

https://github.com/Bytom/dashboard/blob/021021eb4fe1d89a454a6d0269c99ed8e358ee8d/src/features/transactions/components/Show.jsx#L16-L96
...
https://github.com/Bytom/dashboard/blob/021021eb4fe1d89a454a6d0269c99ed8e358ee8d/src/features/transactions/components/Show.jsx#L100-L117
...
https://github.com/Bytom/dashboard/blob/5bb9201e6de21d8c0fba07a60f2773283e49acc7/src/reducers.js#L1-L62
...
在图上有两个红框，左边的表示我现在选择的是初始状态，右边显示最开始`transaction`就已经有了`items`，于是恍然大悟，这不跟前面是一样的道理嘛！于是很快找到了定义：

https://github.com/Bytom/dashboard/blob/e54652cc9d0cfa757d33d1e2fb945a024be2b359/src/features/transactions/reducers.js#L7-L16
...
https://github.com/Bytom/dashboard/blob/c966272a71f692bad1be404b7d4b87ca69195057/src/features/shared/actions/list.js#L4-L147
...
https://github.com/Bytom/dashboard/blob/cf82a65be5bb6d45a0188dc6af2ea6920d2d3005/src/features/shared/reducers.js#L6-L28
